...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.agentregistry.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.agentregistry.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.agentregistry.api.** {
    <init>(...);
