...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentRevokeParams].
         *
    ...
    /** A builder for [AgentRevokeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(agentRevokeParams: AgentRevokeParams) = apply {
            dnaId = agentRevokeParams.dnaId
            body = agentRevokeParams.body.toBuilder()
            additionalHeaders = agentRevokeParams.additionalHeaders.toBuilder()
            additionalQueryParams = agentRevokeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AgentRevokeParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentRevokeParams &&
            dnaId == other.dnaId &&
            body == other.body &&
    ...
    override fun toString() =
        "AgentRevokeParams{dnaId=$dnaId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
