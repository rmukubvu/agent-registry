...
import com.agentregistry.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw AgentregistryInvalidDataException(
        ...
        JsonNodeType.POJO,
        null ->
            throw AgentregistryInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
