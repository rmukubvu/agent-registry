...
package com.agentregistry.api.core

import com.agentregistry.api.core.http.Headers
import com.agentregistry.api.core.http.HttpClient
import com.agentregistry.api.core.http.PhantomReachableClosingHttpClient
import com.agentregistry.api.core.http.QueryParams
import com.agentregistry.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `agentregistry-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.agentregistry.api.core.jsonMapper]. The default is usually sufficient and
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("agentregistry.baseUrl") ?: System.getenv("AGENTREGISTRY_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("agentregistry.apiKey") ?: System.getenv("AGENTREGISTRY_API_KEY"))
                ?.let { apiKey(it) }
        }
