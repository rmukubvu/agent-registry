...
/**
 * A client for interacting with the Agentregistry REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface AgentregistryClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): AgentregistryClientAsync
    ...
    fun enforce(): EnforceServiceAsync
    ...
    /**
     * A view of [AgentregistryClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        fun q(): QServiceAsync.WithRawResponse

        /** Agent registration, governance, lifecycle, and verification. */
        fun agents(): AgentServiceAsync.WithRawResponse

        /** Runtime tool-call enforcement. */
        fun enforce(): EnforceServiceAsync.WithRawResponse
    }
}
