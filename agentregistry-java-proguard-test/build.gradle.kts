...
dependencies {
    testImplementation(project(":agentregistry-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../agentregistry-java-core/src/main/resources/META-INF/proguard/agentregistry-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.agentregistry.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../agentregistry-java-core/src/main/resources/META-INF/proguard/agentregistry-java-core.pro",
