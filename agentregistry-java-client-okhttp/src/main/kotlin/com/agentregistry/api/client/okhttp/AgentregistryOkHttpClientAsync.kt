...
package com.agentregistry.api.client.okhttp

import com.agentregistry.api.client.AgentregistryClientAsync
import com.agentregistry.api.client.AgentregistryClientAsyncImpl
import com.agentregistry.api.core.ClientOptions
import com.agentregistry.api.core.Sleeper
import com.agentregistry.api.core.Timeout
import com.agentregistry.api.core.http.Headers
import com.agentregistry.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [AgentregistryClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AgentregistryOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AgentregistryClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): AgentregistryClientAsync = builder().fromEnv().build()
    }

    /** A builder for [AgentregistryOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.agentregistry.api.core.jsonMapper]. The default is usually sufficient
        ...
        /**
         * Returns an immutable instance of [AgentregistryClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AgentregistryClientAsync =
            AgentregistryClientAsyncImpl(
                clientOptions
                    .httpClient(
