...
import com.agentregistry.api.client.AgentregistryClientImpl
...
/**
 * A class that allows building an instance of [AgentregistryClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AgentregistryOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AgentregistryClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): AgentregistryClient = builder().fromEnv().build()
    }

    /** A builder for [AgentregistryOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AgentregistryClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AgentregistryClient =
            AgentregistryClientImpl(
                clientOptions
                    .httpClient(
